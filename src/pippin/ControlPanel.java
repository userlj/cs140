...
public class ControlPanel implements Observer {
    ...
    public void checkEnabledButtons() {
        ...
        clearButton.setEnabled(machine.getState().getStepActive());
        runButton.setEnabled(machine.getState().getStepActive());
        reloadButton.setEnabled(machine.getState().getStepActive());
