...
public class NamesResource {
	...
	static {
		...
		capitals.put("Asunción", "Paraguay");
		...
		capitals.put("Bogotá", "Colombia");
		capitals.put("Brasília", "Brazil");
		...
		capitals.put("Yamoussoukro", "Côte d\'Ivoire");
		capitals.put("Yaoundé", "Cameroon");
